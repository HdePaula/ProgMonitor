...
square1_frame = tk.Frame(root, bg="blue", pady=10)
square1_frame.grid(row=0, column=0, columnspan=2)
...
lbCpuName = ttk.Label(labels_frame, text=main.getCpuName(), font=fonte_dados)
lbCpuName.grid(row=1, column=0, columnspan=2)

lbCpuFreq = ttk.Label(labels_frame, text="Frequencia de CPU: ", font=fonte_dados)
lbCpuFreq.grid(row=2, column=0)
...
lbCpuUsing.grid(row=3, column=0)
...
lbCpuCount.grid(row=4, column=0)
...
square2_frame = tk.Frame(root, bg="green", pady=10)
square2_frame.grid(row=1, column=0, columnspan=2)
...
lbRamUsingPercent.grid(row=0, column=0)
...
lbRamUsing.grid(row=1, column=0)
...
lbRamTotal.grid(row=3, column=0)
...
rectangle_frame = tk.Frame(root, bg="red", pady=10)
rectangle_frame.grid(row=2, column=0, columnspan=2)
...
lbGpuUsing.grid(row=2, column=0)
...
lbGpuMemoryUsingPercent.grid(row=3, column=0)
...
lbGpuMemoryUsing.grid(row=4, column=0)
...
lbGpuMemoryFree.grid(row=5, column=0)
